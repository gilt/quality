 ...
 * Service version: 0.1.10-7-g76de37a
 * apidoc:0.8.18 http://localhost:9000/gilt/quality/0.1.10-7-g76de37a/play_2_3_client
 */
...
package com.gilt.quality.v0 {
  ...
  object Bindables {
    ...
    private val enumExternalServiceNameNotFound = (key: String, e: Exception) => s"Unrecognized $key, should be one of ${com.gilt.quality.v0.models.ExternalServiceName.all.mkString(", ")}"

    implicit val pathBindableEnumExternalServiceName = new PathBindable.Parsing[com.gilt.quality.v0.models.ExternalServiceName] (
      ExternalServiceName.fromString(_).get, _.toString, enumExternalServiceNameNotFound
    )

    implicit val queryStringBindableEnumExternalServiceName = new QueryStringBindable.Parsing[com.gilt.quality.v0.models.ExternalServiceName](
      ExternalServiceName.fromString(_).get, _.toString, enumExternalServiceNameNotFound
    )

    // Enum: Publication
    private val enumPublicationNotFound = (key: String, e: Exception) => s"Unrecognized $key, should be one of ${com.gilt.quality.v0.models.Publication.all.mkString(", ")}"

    implicit val pathBindableEnumPublication = new PathBindable.Parsing[com.gilt.quality.v0.models.Publication] (
      Publication.fromString(_).get, _.toString, enumPublicationNotFound
    )

    implicit val queryStringBindableEnumPublication = new QueryStringBindable.Parsing[com.gilt.quality.v0.models.Publication](
      Publication.fromString(_).get, _.toString, enumPublicationNotFound
    )

    // Enum: Response
    private val enumResponseNotFound = (key: String, e: Exception) => s"Unrecognized $key, should be one of ${com.gilt.quality.v0.models.Response.all.mkString(", ")}"

    implicit val pathBindableEnumResponse = new PathBindable.Parsing[com.gilt.quality.v0.models.Response] (
      Response.fromString(_).get, _.toString, enumResponseNotFound
    )

    implicit val queryStringBindableEnumResponse = new QueryStringBindable.Parsing[com.gilt.quality.v0.models.Response](
      Response.fromString(_).get, _.toString, enumResponseNotFound
    )

    // Enum: Severity
    private val enumSeverityNotFound = (key: String, e: Exception) => s"Unrecognized $key, should be one of ${com.gilt.quality.v0.models.Severity.all.mkString(", ")}"

    implicit val pathBindableEnumSeverity = new PathBindable.Parsing[com.gilt.quality.v0.models.Severity] (
      Severity.fromString(_).get, _.toString, enumSeverityNotFound
    )

    implicit val queryStringBindableEnumSeverity = new QueryStringBindable.Parsing[com.gilt.quality.v0.models.Severity](
      Severity.fromString(_).get, _.toString, enumSeverityNotFound
    )

    // Enum: Task
    private val enumTaskNotFound = (key: String, e: Exception) => s"Unrecognized $key, should be one of ${com.gilt.quality.v0.models.Task.all.mkString(", ")}"

    implicit val pathBindableEnumTask = new PathBindable.Parsing[com.gilt.quality.v0.models.Task] (
      Task.fromString(_).get, _.toString, enumTaskNotFound
    )

    implicit val queryStringBindableEnumTask = new QueryStringBindable.Parsing[com.gilt.quality.v0.models.Task](
      Task.fromString(_).get, _.toString, enumTaskNotFound
    )
...
package com.gilt.quality.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.8.18 http://localhost:9000/gilt/quality/0.1.10-7-g76de37a/play_2_3_client"
    val Version = "0.1.10-7-g76de37a"
    val VersionMajor = 0
  ...
  class Client(
    apiUrl: String,
    auth: scala.Option[com.gilt.quality.v0.Authorization] = None
  ) {
    import com.gilt.quality.v0.models.json._
    ...
    object AgendaItems extends AgendaItems {
      override def getByOrg(
        ...
        _executeRequest("GET", s"/${play.utils.UriEncoding.encodePathSegment(org, "UTF-8")}/agenda_items", queryParameters = queryParameters).map {
          ...
          case r => throw new com.gilt.quality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200")
        }
      }
      ...
      override def getByOrgAndId(
        ...
        _executeRequest("GET", s"/${play.utils.UriEncoding.encodePathSegment(org, "UTF-8")}/agenda_items/${id}").map {
          ...
          case r => throw new com.gilt.quality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
      ...
      override def postByOrg(
        ...
        _executeRequest("POST", s"/${play.utils.UriEncoding.encodePathSegment(org, "UTF-8")}/agenda_items", body = Some(payload)).map {
          ...
          case r => throw new com.gilt.quality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 201, 409")
        }
      }
      ...
      override def deleteByOrgAndId(
        ...
        _executeRequest("DELETE", s"/${play.utils.UriEncoding.encodePathSegment(org, "UTF-8")}/agenda_items/${id}").map {
          ...
          case r if r.status == 404 => None
          case r => throw new com.gilt.quality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 204, 404")
        }
      }
    }
    ...
    object IncidentOrganizationChanges extends IncidentOrganizationChanges {
      override def post(
        ...
        _executeRequest("POST", s"/incident_organization_changes", body = Some(payload)).map {
          ...
          case r if r.status == 409 => throw new com.gilt.quality.v0.errors.ErrorsResponse(r)
          case r => throw new com.gilt.quality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 409")
        }
      }
    }
