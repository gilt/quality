 ...
 * apidoc:0.9.17 http://www.apidoc.me/gilt/quality/0.1.13/play_2_3_client
 */
...
package com.gilt.quality.v0 {
  ...
  object Bindables {
    ...
    private[this] val enumExternalServiceNameNotFound = (key: String, e: Exception) => s"Unrecognized $key, should be one of ${com.gilt.quality.v0.models.ExternalServiceName.all.mkString(", ")}"
    ...
    // Enum: Publication
    private[this] val enumPublicationNotFound = (key: String, e: Exception) => s"Unrecognized $key, should be one of ${com.gilt.quality.v0.models.Publication.all.mkString(", ")}"
    ...
    // Enum: Response
    private[this] val enumResponseNotFound = (key: String, e: Exception) => s"Unrecognized $key, should be one of ${com.gilt.quality.v0.models.Response.all.mkString(", ")}"
    ...
    // Enum: Severity
    private[this] val enumSeverityNotFound = (key: String, e: Exception) => s"Unrecognized $key, should be one of ${com.gilt.quality.v0.models.Severity.all.mkString(", ")}"
    ...
    // Enum: Task
    private[this] val enumTaskNotFound = (key: String, e: Exception) => s"Unrecognized $key, should be one of ${com.gilt.quality.v0.models.Task.all.mkString(", ")}"
...
package com.gilt.quality.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.9.17 http://www.apidoc.me/gilt/quality/0.1.13/play_2_3_client"
    val Version = "0.1.13"
    val VersionMajor = 0
  ...
  class Client(
    ...
    private[this] val logger = play.api.Logger("com.gilt.quality.v0.Client")
    ...
    object AgendaItems extends AgendaItems {
      override def getByOrg(
        ...
        _executeRequest("GET", s"/${play.utils.UriEncoding.encodePathSegment(org, "UTF-8")}/agenda_items", queryParameters = queryParameters).map {
          ...
          case r if r.status == 404 => throw new com.gilt.quality.v0.errors.UnitResponse(r.status)
      ...
      override def getByOrgAndId(
        ...
        _executeRequest("GET", s"/${play.utils.UriEncoding.encodePathSegment(org, "UTF-8")}/agenda_items/${id}").map {
          case r if r.status == 200 => _root_.com.gilt.quality.v0.Client.parseJson("com.gilt.quality.v0.models.AgendaItem", r, _.validate[com.gilt.quality.v0.models.AgendaItem])
          case r if r.status == 404 => throw new com.gilt.quality.v0.errors.UnitResponse(r.status)
          case r => throw new com.gilt.quality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
      ...
      override def deleteByOrgAndId(
        ...
        _executeRequest("DELETE", s"/${play.utils.UriEncoding.encodePathSegment(org, "UTF-8")}/agenda_items/${id}").map {
          ...
          case r => throw new com.gilt.quality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 204")
        }
      }
    }
    ...
    object EmailMessages extends EmailMessages {
      override def getMeetingAdjournedByOrgAndMeetingId(
        org: String,
        meetingId: Long
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[com.gilt.quality.v0.models.EmailMessage] = {
        _executeRequest("GET", s"/${play.utils.UriEncoding.encodePathSegment(org, "UTF-8")}/email_messages/meeting_adjourned/${meetingId}").map {
          case r if r.status == 200 => _root_.com.gilt.quality.v0.Client.parseJson("com.gilt.quality.v0.models.EmailMessage", r, _.validate[com.gilt.quality.v0.models.EmailMessage])
          case r if r.status == 404 => throw new com.gilt.quality.v0.errors.UnitResponse(r.status)
          case r => throw new com.gilt.quality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
    ...
    object ExternalServices extends ExternalServices {
      ...
      override def getByOrgAndId(
        ...
        _executeRequest("GET", s"/${play.utils.UriEncoding.encodePathSegment(org, "UTF-8")}/external_services/${id}").map {
          case r if r.status == 200 => _root_.com.gilt.quality.v0.Client.parseJson("com.gilt.quality.v0.models.ExternalService", r, _.validate[com.gilt.quality.v0.models.ExternalService])
          case r if r.status == 404 => throw new com.gilt.quality.v0.errors.UnitResponse(r.status)
          case r => throw new com.gilt.quality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
    ...
    object Healthchecks extends Healthchecks {
      override def getInternalAndHealthcheck()(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[com.gilt.quality.v0.models.Healthcheck] = {
        _executeRequest("GET", s"/_internal_/healthcheck").map {
          case r if r.status == 200 => _root_.com.gilt.quality.v0.Client.parseJson("com.gilt.quality.v0.models.Healthcheck", r, _.validate[com.gilt.quality.v0.models.Healthcheck])
    ...
    object Meetings extends Meetings {
      ...
      override def getPagerByOrgAndIdAndIncidentId(
        ...
        id: Long,
        incidentId: Long
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[com.gilt.quality.v0.models.MeetingPager] = {
        _executeRequest("GET", s"/${play.utils.UriEncoding.encodePathSegment(org, "UTF-8")}/meetings/${id}/pager/${incidentId}").map {
          case r if r.status == 200 => _root_.com.gilt.quality.v0.Client.parseJson("com.gilt.quality.v0.models.MeetingPager", r, _.validate[com.gilt.quality.v0.models.MeetingPager])
          case r if r.status == 404 => throw new com.gilt.quality.v0.errors.UnitResponse(r.status)
          case r => throw new com.gilt.quality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
    ...
    object Organizations extends Organizations {
      ...
      override def getByKey(
        ...
        _executeRequest("GET", s"/organizations/${play.utils.UriEncoding.encodePathSegment(key, "UTF-8")}").map {
          case r if r.status == 200 => _root_.com.gilt.quality.v0.Client.parseJson("com.gilt.quality.v0.models.Organization", r, _.validate[com.gilt.quality.v0.models.Organization])
          case r if r.status == 404 => throw new com.gilt.quality.v0.errors.UnitResponse(r.status)
          case r => throw new com.gilt.quality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
    ...
    object Subscriptions extends Subscriptions {
      ...
      override def getById(
        ...
        _executeRequest("GET", s"/subscriptions/${id}").map {
          case r if r.status == 200 => _root_.com.gilt.quality.v0.Client.parseJson("com.gilt.quality.v0.models.Subscription", r, _.validate[com.gilt.quality.v0.models.Subscription])
          case r if r.status == 404 => throw new com.gilt.quality.v0.errors.UnitResponse(r.status)
          case r => throw new com.gilt.quality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
    ...
    object Teams extends Teams {
      ...
      override def getMemberSummaryByOrgAndKey(
        org: String,
        key: String
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[com.gilt.quality.v0.models.TeamMemberSummary] = {
        _executeRequest("GET", s"/${play.utils.UriEncoding.encodePathSegment(org, "UTF-8")}/teams/${play.utils.UriEncoding.encodePathSegment(key, "UTF-8")}/member_summary").map {
          case r if r.status == 200 => _root_.com.gilt.quality.v0.Client.parseJson("com.gilt.quality.v0.models.TeamMemberSummary", r, _.validate[com.gilt.quality.v0.models.TeamMemberSummary])
          case r if r.status == 404 => throw new com.gilt.quality.v0.errors.UnitResponse(r.status)
          case r => throw new com.gilt.quality.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
  ...
  trait Healthchecks {
    def getInternalAndHealthcheck()(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[com.gilt.quality.v0.models.Healthcheck]
  }
