 ...
 * Service version: 0.1.11-foo
 * apidoc:0.8.15 http://localhost:9000/gilt/quality/0.1.11-foo/play_2_3_client
 */
...
package com.gilt.quality.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.8.15 http://localhost:9000/gilt/quality/0.1.11-foo/play_2_3_client"
    val Version = "0.1.11-foo"
    val VersionMajor = 0
