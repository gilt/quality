 ...
 * apidoc:0.7.41 http://localhost:9000/gilt/quality/0.1.10/play_2_3_client
 */
...
package com.gilt.quality.v0 {
  ...
  class Client(
    ...
    private val UserAgent = "apidoc:0.7.41 http://localhost:9000/gilt/quality/0.1.10/play_2_3_client"
